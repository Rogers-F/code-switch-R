  ...
  <div class="main-shell">
    <header class="app-page-header">
      <div class="app-page-title-group">
        <h1 class="app-page-title">{{ t('components.mcp.hero.title') }}</h1>
        <p class="app-page-subtitle">{{ t('components.mcp.hero.lead') }}</p>
      </div>
      <div class="app-page-actions">
        ...
        <button class="ghost-icon" :aria-label="t('components.mcp.controls.create')" :title="t('components.mcp.controls.create')" @click="openCreateModal">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
              d="M12 5v14M5 12h14"
              stroke="currentColor"
        ...
        <button class="ghost-icon" :aria-label="t('components.mcp.import.title')" :title="t('components.mcp.import.title')" @click="openBatchImport">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
        ...
        <button class="ghost-icon" :aria-label="t('components.mcp.controls.settings')" :title="t('components.mcp.controls.settings')" @click="goToSettings">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
