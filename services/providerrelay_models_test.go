...
func setupRelayForTest(t *testing.T) (*ProviderService, *ProviderRelayService) {
	t.Helper()
...
func TestModelsHandler(t *testing.T) {
	...
	// 创建测试用的服务
	providerService, relayService := setupRelayForTest(t)
...
func TestModelsHandler_NoProviders(t *testing.T) {
	...
	_, relayService := setupRelayForTest(t)
